...
import {
  ...
  length, texture, screenUV, uv, varying, sRGBTransferOETF,
} from 'three/tsl';
...
function createSplatMaterial({ positions, colors, alphas, pxPerWorldU, bandwidthPxU }) {
...
export function createSplatScene({ count, positions, colors, alphas, pxPerWorldU, bandwidthPxU }) {
  const material = createSplatMaterial({ positions, colors, alphas, pxPerWorldU, bandwidthPxU });
